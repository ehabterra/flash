...
// GetRatesHandler is an autogenerated mock type for the GetRatesHandler type
type GetRatesHandler struct {
	mock.Mock
}

// Handle provides a mock function with given fields: _a0, _a1
func (_m *GetRatesHandler) Handle(_a0 rates.GetRatesParams, _a1 *models.Principle) middleware.Responder {
