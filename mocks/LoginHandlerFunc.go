...
// LoginHandlerFunc is an autogenerated mock type for the LoginHandlerFunc type
type LoginHandlerFunc struct {
	mock.Mock
}

// Execute provides a mock function with given fields: _a0
func (_m *LoginHandlerFunc) Execute(_a0 users.LoginParams) middleware.Responder {
	ret := _m.Called(_a0)
