...
// SendHandlerFunc is an autogenerated mock type for the SendHandlerFunc type
type SendHandlerFunc struct {
	mock.Mock
}

// Execute provides a mock function with given fields: _a0, _a1
func (_m *SendHandlerFunc) Execute(_a0 users.SendParams, _a1 *models.Principle) middleware.Responder {
