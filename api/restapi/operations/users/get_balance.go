...
type GetBalanceHandlerFunc func(GetBalanceParams, *models.Principle) middleware.Responder

// Handle executing the request and returning a response
func (fn GetBalanceHandlerFunc) Handle(params GetBalanceParams, principal *models.Principle) middleware.Responder {
	return fn(params, principal)
}

// GetBalanceHandler interface for that can handle valid get balance params
type GetBalanceHandler interface {
	Handle(GetBalanceParams, *models.Principle) middleware.Responder
}
...
/* GetBalance swagger:route GET /api/v1/users/me/balance users getBalance
