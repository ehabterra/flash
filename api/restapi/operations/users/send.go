...
type SendHandlerFunc func(SendParams, *models.Principle) middleware.Responder

// Handle executing the request and returning a response
func (fn SendHandlerFunc) Handle(params SendParams, principal *models.Principle) middleware.Responder {
	return fn(params, principal)
}

// SendHandler interface for that can handle valid send params
type SendHandler interface {
	Handle(SendParams, *models.Principle) middleware.Responder
}
...
/* Send swagger:route POST /api/v1/users/me/transfers/{username_or_email} users send
