...
func (m *LoginRequest) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateUsernameOrEmail(formats); err != nil {
		res = append(res, err)
	}
...
func (m *LoginRequest) validateUsernameOrEmail(formats strfmt.Registry) error {

	if err := validate.Required("username_or_email", "body", m.UsernameOrEmail); err != nil {
		return err
	}

	if err := validate.MinLength("username_or_email", "body", *m.UsernameOrEmail, 1); err != nil {
		return err
	}
